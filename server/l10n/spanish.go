...
var spanish = map[string]string{
	...
	"PEP: Preparedness Education":                                                  "PEP: Educación de preparación",
	...
	"If you are a student in an OES-organized class, such as CERT or PEP, your basic and restricted information may be shared with the class instructors as long as the class is in progress.":                                                                                                         "Si es estudiante de una clase organizada por OSE, como CERT o PPDE, su información básica y restringida puede ser compartida con los instructores mientras la clase esté en curso.",
