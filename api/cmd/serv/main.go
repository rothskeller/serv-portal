...
var commands = []command{
	...
	// {[]string{"person", "?", "email", "add", ".", "="}, handler},
	// {[]string{"person", "?", "email", "«index»", "set", "="}, handler},
	// {[]string{"person", "?", "email", "«index»", "remove"}, handler},
	...
	// {[]string{"person", "?", "role", "add", "+"}, handler},
	// {[]string{"person", "?", "role", "remove", "+"}, handler},
	// {[]string{"person", "?", "role", "set", "+"}, handler},
