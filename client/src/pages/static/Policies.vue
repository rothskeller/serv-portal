<!--
Policies displays a page with information about the site policies.
-->
...
#policies
  ...
  p.
    ...
    <a href="https://vuejs.org/" target="_blank">Vue</a> framework.  The server
    side of this web site is written in Go, with data storage in a SQLite
    database.
  p.
