// Validated form check box group control.

import { defineComponent, h, PropType, ref, watchEffect } from 'vue'
import SCheckGroup from '../controls/cgroup'
  ...
  setup(props, { attrs, emit }) {
    ...
    function renderInput() {
      return h(SCheckGroup, {
        ...
        'onUpdate:modelValue': (v: Set<unknown>) => emit('update:modelValue', v),
      })
    }

    // Render a FormItem, with an SCheckGroup inside it.
    return () =>
      h(
        FormItem,
        {
