...
The Sunnyvale Office of Emergency Services would like to be sure that you get credit for all of the volunteer work you did for SERV, CERT, PEP, SARES, and/or SNAP during {{ .Month }}.  However, you are not currently registered as a City of Sunnyvale volunteer, so we cannot record your volunteer work.  To register as a City of Sunnyvale volunteer, please visit your profile on the Sunnyvale SERV website (https://SunnyvaleSERV.org) and click the "Register" button in the "Volunteer Status" area.  If you have any difficulties with this, just reply to this email.

Many thanks,
Sunnyvale OES
`))

var noVolgisticsHTML = htemplate.Must(htemplate.New("").Parse(`<html><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8"></head><body><div>Hello, {{ .Name }},</div><div><br></div><div>The Sunnyvale Office of Emergency Services would like to be sure that you get credit for all of the volunteer work you did for SERV, CERT, PEp, SARES, and/or SNAP during {{ .Month }}.  However, you are not currently registered as a City of Sunnyvale volunteer, so we cannot record your volunteer work.  To register as a City of Sunnyvale volunteer, please visit your profile on the <a href="https://sunnyvaleserv.org/">Sunnyvale SERV website</a> and click the “Register” button in the “Volunteer Status” area.  If you have any difficulties with this, just reply to this email.</div><div><br></div><div>Many thanks,<br>Sunnyvale OES</div></body></html>`))
...
The Sunnyvale Office of Emergency Services would like to be sure that you get credit for all of the volunteer work you may have done for SERV, CERT, PEp, SARES, and/or SNAP during {{ .Month }}.  Currently, {{ if .Tasks }}our records show:
