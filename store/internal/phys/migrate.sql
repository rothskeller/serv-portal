...
INSERT INTO new_person SELECT id, volgistics_id, informal_name, formal_name, sort_name, call_sign,
pronouns, email, email2, cell_phone, home_phone, work_phone, password, bad_login_count, bad_login_time,
pwreset_token, pwreset_time, unsubscribe_token, hours_token, identification, birthdate, 'en', flags
FROM person;
DROP TABLE person;
