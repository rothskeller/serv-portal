...
func NotFound(r *request.Request, user *person.Person) {
	ui.Page(r, user, ui.PageOpts{
		...
		main.E("h1>No Such Page")
		main.E(`p>Sorry, the page you asked for doesn’t exist.
But we have plenty of other good ones!  You can
...
func Forbidden(r *request.Request, user *person.Person) {
	...
	ui.Page(r, user, ui.PageOpts{StatusCode: http.StatusForbidden}, func(main *htmlb.Element) {
		main.A("class=errpage")
		main.E("h1>Forbidden")
		main.E(`p>Sorry, but your account doesn’t have permissions
for the operation you requested.  If you think you should have permissions,
contact <a href="mailto:admin@sunnyvaleserv.org">admin@SunnyvaleSERV.org</a> for
assistance.`)
	})
}
...
func ServerError(r *request.Request, user *person.Person) {
	ui.Page(r, user, ui.PageOpts{
		...
		main.A("class=errpage")
		main.E("h1>Web Site Error")
		main.E(`p>We’re sorry, but this web site isn’t working
correctly right now.  This problem has been reported to the site administrator.
