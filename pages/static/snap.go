...
// SNAPPage handles GET /snap requests.
func SNAPPage(r *request.Request) {
	...
	ui.Page(r, user, ui.PageOpts{Title: "SNAP"}, func(main *htmlb.Element) {
		...
		main.E("p").R(r.Loc("For more information about SNAP, or to arrange a MYN meeting for your neighborhood, click the button below and fill out the contact form.  Alternatively, you can write to <a href=mailto:snap@sunnyvale.ca.gov target=_blank>snap@sunnyvale.ca.gov</a>."))
		main.E("div class=staticBack").E("a href=https://forms.gle/bXfpRsGohY9biBi87 target=_blank class='sbtn sbtn-primary'").R(r.Loc("Request Information"))
	})
}
