...
func GetPEP(r *request.Request) {
	...
	ui.Page(r, user, ui.PageOpts{
		...
		if r.Language == "es" {
			classes.E("div").R(`Sábado, el 24 de enero, 2:00–4:00pm
Impartido en inglés
Biblioteca Pública de Sunnyvale
665 W. Olive Avenue, Sunnyvale`)
		} else {
			classes.E("div").R(`Saturday, January 24, 2:00–4:00pm
Taught in English
Sunnyvale Public Library
665 W. Olive Avenue, Sunnyvale`)
		}
		classes.E("div").E("a href=https://sunnyvale.libcal.com/event/15516589 target=_blank class='sbtn sbtn-primary sbtn-small'").R(r.Loc("Sign Up"))
