...
func easyjson6578def1EncodeSunnyvaleservOrgPortalModel7(out *jwriter.Writer, in Person) {
	...
	}
	{
		...
		if in.DSWRegistrations == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v21First := true
			for v21Name, v21Value := range in.DSWRegistrations {
				if v21First {
					v21First = false
				} else {
					out.RawByte(',')
	...
	}
	{
		...
		if in.DSWUntil == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v22First := true
			for v22Name, v22Value := range in.DSWUntil {
				if v22First {
					v22First = false
				} else {
					out.RawByte(',')
		...
		case "no_email":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v23 PersonID
					v23 = PersonID(in.Int())
					out.NoEmail = append(out.NoEmail, v23)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "no_text":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v24 PersonID
					v24 = PersonID(in.Int())
					out.NoText = append(out.NoText, v24)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "documents":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Documents = append(out.Documents, v29)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson6578def1EncodeSunnyvaleservOrgPortalModel9(out *jwriter.Writer, in Folder) {
	...
	if len(in.Documents) != 0 {
		...
		{
			out.RawByte('[')
			for v30, v31 := range in.Documents {
				if v30 > 0 {
					out.RawByte(',')
				}
				if v31 == nil {
