		...
		case "no_email":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v22 PersonID
					v22 = PersonID(in.Int())
					out.NoEmail = append(out.NoEmail, v22)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "no_text":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v23 PersonID
					v23 = PersonID(in.Int())
					out.NoText = append(out.NoText, v23)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "documents":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Documents = append(out.Documents, v28)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson6578def1EncodeSunnyvaleservOrgPortalModel9(out *jwriter.Writer, in Folder) {
	...
	if len(in.Documents) != 0 {
		...
		{
			out.RawByte('[')
			for v29, v30 := range in.Documents {
				if v29 > 0 {
					out.RawByte(',')
				}
				if v30 == nil {
