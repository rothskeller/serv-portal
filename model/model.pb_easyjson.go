	...
	for !in.IsDelim('}') {
		...
		case "dsw_forms":
			if in.IsNull() {
				...
				if out.DSWForms == nil {
					if !in.IsDelim(']') {
						out.DSWForms = make([]*DSWForm, 0, 8)
					} else {
						out.DSWForms = []*DSWForm{}
					}
				} else {
					out.DSWForms = (out.DSWForms)[:0]
				}
				for !in.IsDelim(']') {
					var v15 *DSWForm
					if in.IsNull() {
					...
					out.DSWForms = append(out.DSWForms, v15)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson6578def1EncodeSunnyvaleservOrgPortalModel7(out *jwriter.Writer, in Person) {
	...
	if len(in.DSWForms) != 0 {
		const prefix string = ",\"dsw_forms\":"
		out.RawString(prefix)
		{
			out.RawByte('[')
			for v22, v23 := range in.DSWForms {
				if v22 > 0 {
					out.RawByte(',')
				}
				if v23 == nil {
	...
	}
	{
		...
		if in.DSWRegistrations == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v24First := true
			for v24Name, v24Value := range in.DSWRegistrations {
				if v24First {
					v24First = false
				} else {
					out.RawByte(',')
	...
	}
	{
		...
		if in.DSWUntil == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v25First := true
			for v25Name, v25Value := range in.DSWUntil {
				if v25First {
					v25First = false
				} else {
					out.RawByte(',')
		...
		case "no_email":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v26 PersonID
					v26 = PersonID(in.Int())
					out.NoEmail = append(out.NoEmail, v26)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "no_text":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v27 PersonID
					v27 = PersonID(in.Int())
					out.NoText = append(out.NoText, v27)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "documents":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Documents = append(out.Documents, v32)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson6578def1EncodeSunnyvaleservOrgPortalModel9(out *jwriter.Writer, in Folder) {
	...
	if len(in.Documents) != 0 {
		...
		{
			out.RawByte('[')
			for v33, v34 := range in.Documents {
				if v33 > 0 {
					out.RawByte(',')
				}
				if v34 == nil {
...
func easyjson6578def1DecodeSunnyvaleservOrgPortalModel13(in *jlexer.Lexer, out *DSWForm) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "for":
			out.For = string(in.String())
		case "invalid":
			out.Invalid = string(in.String())
		default:
			in.SkipRecursive()
		}
		in.WantComma()
...
func easyjson6578def1EncodeSunnyvaleservOrgPortalModel13(out *jwriter.Writer, in DSWForm) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	if in.For != "" {
		const prefix string = ",\"for\":"
		out.RawString(prefix)
		out.String(string(in.For))
	}
	if in.Invalid != "" {
		const prefix string = ",\"invalid\":"
		out.RawString(prefix)
		out.String(string(in.Invalid))
	}
	out.RawByte('}')
}

// MarshalJSON supports json.Marshaler interface
func (v DSWForm) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
...
// MarshalEasyJSON supports easyjson.Marshaler interface
func (v DSWForm) MarshalEasyJSON(w *jwriter.Writer) {
	easyjson6578def1EncodeSunnyvaleservOrgPortalModel13(w, v)
}

// UnmarshalJSON supports json.Unmarshaler interface
func (v *DSWForm) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
...
// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *DSWForm) UnmarshalEasyJSON(l *jlexer.Lexer) {
