		...
		case "emails":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Emails = append(out.Emails, v13)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "roles":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v15 RoleID
					v15 = RoleID(in.Int())
					out.Roles = append(out.Roles, v15)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "archive":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Archive = append(out.Archive, v16)
					in.WantComma()
				}
				in.Delim(']')
			}
