...
func OrgDot(elm *htmlb.Element, org enum.Org) {
	...
	case enum.OrgCERTD:
		elm.E("span class=orgdot style='border:2px solid #3cb44b;background-color:white' title='CERT Deployment'")
	case enum.OrgCERTT:
		elm.E("span class=orgdot style=background-color:#3cb44b title='CERT Training'")
	case enum.OrgListos:
